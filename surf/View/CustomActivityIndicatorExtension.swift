//
//  CustomActivityIndicatorExtension.swift
//  
//
...
extension UIView{
    func customActivityIndicator(view: UIView, widthView: CGFloat?,backgroundColor: UIColor?, textColor:UIColor?, message: String?) -> ActivityIndicatorView{
...
//        label.font = UIFont(name: "SFUIDisplay-Regular", size: 17.0)! // Your Desired UIFont Style and Size
        ...
        if let customView = self as? ActivityIndicatorView{
            return customView
