...
class ActivityIndicatorView: UIView {
    ...
    func setupActivityIndicator(view: UIView, widthView: CGFloat?,backgroundColor: UIColor?, textColor:UIColor?, message: String?) -> ActivityIndicatorView{
        ...
        let imageListArray = [#imageLiteral(resourceName: "Mini_Flat"),#imageLiteral(resourceName: "Mini_bump"),#imageLiteral(resourceName: "Mini_littlewave"),#imageLiteral(resourceName: "Mini_wave"),#imageLiteral(resourceName: "Mini_bigwave")]
